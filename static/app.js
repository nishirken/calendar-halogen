(() => {
  ...
  function replaceState(a2) {
    return function(docTitle) {
      return function(url2) {
        return function(history2) {
          return function() {
            return history2.replaceState(a2, docTitle, url2);
          };
        };
      };
    };
  }
  function state2(history2) {
    return function() {
    ...
    return function(dictIsSymbol) {
      return function(dictOrd) {
        return function(sym) {
          return function(key) {
            return function(v) {
              return lookup(ordTuple(ordString)(ordOrdBox))(new Tuple(reflectSymbol(dictIsSymbol)(sym), mkOrdBox(dictOrd)(key)))(v);
            };
          };
        };
      };
  ...
  var disabled10 = /* @__PURE__ */ prop2(isPropBoolean)("disabled");
        ...
        return function(label5) {
          return function(p2) {
            return function(component7) {
              return function(input4) {
                return widget(new ComponentSlot(componentSlot()(dictIsSymbol)(dictOrd)(label5)(p2)(component7)(input4)($$const(Nothing.value))));
              };
            };
          };
        };
        ...
        return function(lchs) {
          return function __do3() {
            ...
            var ds = {
              ...
              state: component7.initialState(input4),
              refs: empty2,
              children: empty3,
              childrenIn,
              childrenOut,
              ...
              return bind(bindAff)(fresh(ForkId)(ref2))(function(fid) {
                return bind(bindAff)(liftEffect(monadEffectAff)(read(ref2)))(function(v2) {
                  return bind(bindAff)(liftEffect(monadEffectAff)($$new(false)))(function(doneRef) {
                    return bind(bindAff)(fork(monadForkAff)($$finally(liftEffect(monadEffectAff)(function __do3() {
  ...
  function setNodeValue(value14) {
    return function(node) {
      return function() {
        node.nodeValue = value14;
      };
    };
  }
  ...
  function toRFC3896(input4) {
    return input4.replace(/[!'()*]/g, function(c) {
      return "%" + c.charCodeAt(0).toString(16);
    });
  }
  var _encodeFormURLComponent = function encode(fail2, succeed, input4) {
    try {
      return succeed(toRFC3896(encodeURIComponent(input4)).replace(/%20/g, "+"));
    } catch (err) {
      return fail2(err);
    }
  };
  ...
  var request2 = function(driver2) {
    return function(req) {
      ...
      var addHeader = function(mh) {
        return function(hs) {
          if (mh instanceof Just && !any(foldableArray)(heytingAlgebraBoolean)(on(eq(eqString))(name15)(mh.value0))(hs)) {
  ...
  var post_ = function(driver2) {
    return function(url2) {
      var $60 = map(functorAff)($$void(functorEither));
      var $61 = post(driver2)(ignore)(url2);
      return function($62) {
        return $60($61($62));
      };
    };
  ...
  var post_2 = /* @__PURE__ */ post_(driver);
  ...
  var extend2 = function(encoder) {
    return function(v) {
      var $32 = caseJsonObject(jsonSingletonObject(v.value0)(v.value1))(function() {
        var $34 = insert3(v.value0)(v.value1);
        return function($35) {
          return id2($34($35));
        };
      }());
  ...
  // output/Models.Auth/index.js
  var encodeAuthCreds = {
    encodeJson: function(v) {
      return extend3(encodeJsonJson)(assoc2(encodeJsonJString)("email")(v.email))(extend3(encodeJsonJson)(assoc2(encodeJsonJString)("password")(v.password))(jsonEmptyObject));
    }
  };

  // output/Url/index.js
  var mkUrl = function(isDev) {
  ...
  // output/Api.Auth/index.js
  var signin = function(creds) {
    return post_2(mkUrl(true)("/auth/signin"))(new Just(new Json(encodeJson(encodeAuthCreds)(creds))));
  };

  // output/Component.Link/index.js
  var link3 = /* @__PURE__ */ element2("wired-link");
  ...
  var invalid2 = function($68) {
    return V(Left.create($68));
  };
  ...
  var runMatch = function(v) {
    return function(route) {
      var foldErrors = function(errs) {
        return new Left(foldl(foldableList)(function(b2) {
          return function(a2) {
            return a2 + ("\n" + b2);
          };
    ...
    apply: function(v) {
      return function(v1) {
        ...
        var processFnErr = function(r) {
          return function(err) {
            return invalid2(mul(semiringFree)(err)(validation(identity(categoryFn))($$const(one(semiringFree)))(v1(r))));
          };
        };
        return function(r) {
  ...
  var lit = function(input4) {
    return function(route) {
      if (route instanceof Cons && (route.value0 instanceof Path && route.value0.value0 === input4)) {
        return pure(applicativeV(semiringFree))(new Tuple(route.value1, unit));
      }
      ;
      if (route instanceof Cons && route.value0 instanceof Path) {
        return invalid2(free(new UnexpectedPath(input4)));
      }
      ;
  ...
  var setHash2 = function(h) {
    return bind(bindEffect)(bind(bindEffect)(windowImpl)(location))(setHash(h));
  };
  ...
  // output/RouterLink/index.js
  var LinkClick = /* @__PURE__ */ function() {
    function LinkClick2(value0, value1) {
      this.value0 = value0;
      this.value1 = value1;
    }
    ;
    LinkClick2.create = function(value0) {
      return function(value1) {
        return new LinkClick2(value0, value1);
      };
    };
    return LinkClick2;
  }();
  var InputReceived = /* @__PURE__ */ function() {
    function InputReceived2(value0) {
      this.value0 = value0;
    }
    ;
    InputReceived2.create = function(value0) {
      return new InputReceived2(value0);
    };
    return InputReceived2;
  }();
  var slotId = /* @__PURE__ */ function() {
    return $$Proxy.value;
  }();
  var component = function(dictMonadEffect) {
    var render = function(s) {
      return link3([onClick(LinkClick.create(s.hash))])([text5(s.text)]);
    };
    var receive = function(input4) {
      return new Just(new InputReceived(input4));
    };
    var handleAction = function(v) {
      if (v instanceof InputReceived) {
        return modify_2(monadStateHalogenM)($$const(v.value0));
      }
      ;
      if (v instanceof LinkClick) {
        return liftEffect(monadEffectHalogenM(dictMonadEffect))(function __do3() {
          preventDefault(toEvent(v.value1))();
          return setHash2(v.value0)();
        });
      }
      ;
      throw new Error("Failed pattern match at RouterLink (line 44, column 5 - line 44, column 69): " + [v.constructor.name]);
    };
    return mkComponent({
  ...
  // output/Auth.Hint/index.js
  var slotId2 = /* @__PURE__ */ function() {
    return $$Proxy.value;
  }();
  var component2 = function(dictMonadEffect) {
    var render = function(s) {
      return div2([class_("auth-form__hint")])([text5(s.text), slot_()({
        reflectSymbol: function() {
          return "routerLink";
        }
      })(ordUnit)(slotId)(unit)(component(dictMonadEffect))({
        hash: s.linkHash,
        text: s.linkText
      })]);
    };
  ...
  // output/Component.Button/index.js
  var button3 = function(wiredAttrs) {
    return function(text6) {
      return function(htmlAttrs) {
        var wiredAttrs$prime = function() {
          if (wiredAttrs instanceof Just) {
            return [attr2("elevation")(show(showInt)(wiredAttrs.value0.elevation))];
          }
          ;
          if (wiredAttrs instanceof Nothing) {
            return [];
          }
          ;
          throw new Error("Failed pattern match at Component.Button (line 22, column 19 - line 24, column 20): " + [wiredAttrs.constructor.name]);
        }();
        return element2("wired-button")(append(semigroupArray)(htmlAttrs)(wiredAttrs$prime))([text5(text6)]);
      };
    };
  };

  // output/Component.Input/index.js
  var input3 = function(attrs) {
    return element2("wired-input")(attrs)([]);
  };

  // output/Utils/foreign.js
  var unsafeInputValue = (toJust) => (toNothing) => (toEffect) => (event) => {
  ...
  var getInputValue = function(ev) {
    return unsafeInputValue(function(x) {
      return new Just(x);
    })($$const(Nothing.value))(function(x) {
      return pure(applicativeEffect)(x);
    })(ev);
  };

  // output/Auth.AuthForm/index.js
  ...
  var EmailInput = /* @__PURE__ */ function() {
    function EmailInput2(value0) {
      this.value0 = value0;
    }
    ;
    EmailInput2.create = function(value0) {
      return new EmailInput2(value0);
    };
    return EmailInput2;
  }();
  var PasswordInput = /* @__PURE__ */ function() {
    function PasswordInput2(value0) {
      this.value0 = value0;
    }
    ;
    PasswordInput2.create = function(value0) {
      return new PasswordInput2(value0);
    };
    return PasswordInput2;
  }();
  var slotId3 = /* @__PURE__ */ function() {
    return $$Proxy.value;
  }();
  var component3 = function(dictMonadEffect) {
    var updateInputState = function(ev) {
      return function(f) {
        return bind(bindHalogenM)(liftEffect(monadEffectHalogenM(dictMonadEffect))(getInputValue(ev)))(function(val) {
          if (val instanceof Just) {
            return modify_2(monadStateHalogenM)(function(s) {
              return f(s)(val.value0);
            });
          }
          ;
          ...
          ;
          throw new Error("Failed pattern match at Auth.AuthForm (line 172, column 7 - line 174, column 29): " + [val.constructor.name]);
        });
      };
    };
    var passwordInput = input3([placeholder3("Password"), type_17(isPropInputType)(InputPassword.value), onInput(PasswordInput.create), class_("auth-form__input")]);
    var initialState = function(v) {
      return {
        ...
        fetch: v.fetch,
        hintText: v.hintText,
        hintLinkText: v.hintLinkText,
        hintLinkHash: v.hintLinkHash
      };
    };
    var handleAction = function(action2) {
      if (action2 instanceof Submit) {
        return discard(discardUnit)(bindHalogenM)(modify_2(monadStateHalogenM)(function(s) {
          var $23 = {};
          for (var $24 in s) {
          ...
          return bind(bindHalogenM)(gets(monadStateHalogenM)(function(s) {
            return s.fetch;
          }))(function(fetch$prime) {
            return bind(bindHalogenM)(gets(monadStateHalogenM)(function(s) {
              return {
                email: s.email,
                password: s.password
              ...
              return discard(discardUnit)(bindHalogenM)(liftEffect(monadEffectHalogenM(dictMonadEffect))(fetch$prime(creds)))(function() {
                return modify_2(monadStateHalogenM)(function(v) {
                  var $26 = {};
                  for (var $27 in v) {
      ...
      ;
      if (action2 instanceof EmailInput) {
        return updateInputState(action2.value0)(function(s) {
          return function(val) {
            return {
              email: val,
              password: s.password,
              ...
              fetch: s.fetch,
              hintText: s.hintText,
              hintLinkHash: s.hintLinkHash,
              hintLinkText: s.hintLinkText
            };
          };
        });
      }
      ;
      if (action2 instanceof PasswordInput) {
        return updateInputState(action2.value0)(function(s) {
          return function(val) {
            return {
              email: s.email,
      ...
      ;
      throw new Error("Failed pattern match at Auth.AuthForm (line 177, column 27 - line 185, column 79): " + [action2.constructor.name]);
    };
    var emailInput = input3([placeholder3("Email"), type_17(isPropInputType)(InputEmail.value), onInput(EmailInput.create), class_("auth-form__input")]);
    var button4 = function(s) {
      return button3(Nothing.value)(s.buttonText)([disabled10(s.loading), type_17(isPropButtonType)(ButtonSubmit.value), onClick(Submit.create), class_("auth-form__button")]);
    };
    var render = function(s) {
      return div2([class_("auth-form")])([emailInput, passwordInput, button4(s), slot_()({
        reflectSymbol: function() {
          return "authHint";
        }
      })(ordUnit)(slotId2)(unit)(component2(dictMonadEffect))({
        text: s.hintText,
        linkText: s.hintLinkText,
        linkHash: s.hintLinkHash
      })]);
    };
    return mkComponent({
      initialState,
  ...
  var routing = /* @__PURE__ */ function() {
    return alt(matchAlt)(applySecond(matchApply)(lit("/auth/signin"))(pure(matchApplicative)(new Auth(Signin.value))))(alt(matchAlt)(applySecond(matchApply)(lit("/auth/signup"))(pure(matchApplicative)(new Auth(Signup.value))))(alt(matchAlt)(applySecond(matchApply)(lit("/week"))(pure(matchApplicative)(Week.value)))(applySecond(matchApply)(lit("/404"))(pure(matchApplicative)(NotFound.value)))));
  }();
  var routes = function(v) {
    if (v instanceof Auth && v.value0 instanceof Signin) {
      return "/auth/signin";
    }
    ;
    if (v instanceof Auth && v.value0 instanceof Signup) {
      return "/auth/signup";
    }
    ;
    ...
    ;
    throw new Error("Failed pattern match at Routes (line 24, column 1 - line 24, column 26): " + [v.constructor.name]);
  };

  // output/Auth.SigninForm/index.js
  var slotId4 = /* @__PURE__ */ function() {
    return $$Proxy.value;
  }();
  var component4 = function(dictMonadEffect) {
    var fetch = function(creds) {
      return function __do3() {
        var res = runHalogenAff(signin(creds))();
        return logShow2(monadEffectEffect)(showUnit)(res)();
      };
    };
    var render = function(v) {
      ...
      })(ordUnit)(slotId3)(unit)(component3(dictMonadEffect))({
        buttonText: "Sign in",
        fetch,
        hintText: "Do not have an account yet?",
        hintLinkText: "Sign up",
        hintLinkHash: routes(new Auth(Signup.value))
      });
    };
    return mkComponent({
      initialState: identity(categoryFn),
  ...
  // output/Auth.SignupForm/index.js
  var slotId5 = /* @__PURE__ */ function() {
    return $$Proxy.value;
  }();
  var component5 = function(dictMonadEffect) {
    ...
    var render = function(v) {
      return div_([slot_()({
        ...
        hintLinkHash: routes(new Auth(Signin.value))
      })]);
    };
    return mkComponent({
      initialState: identity(categoryFn),
  ...
  // output/Routing.PushState/index.js
  var makeImmediate = function(run3) {
    return function __do3() {
      var document2 = bind(bindEffect)(windowImpl)(function() {
        var $7 = map(functorEffect)(toDocument);
        return function($8) {
          return $7(document($8));
        };
      }())();
      var nextTick = $$new(new Right(0))();
      var obsvNode = map(functorEffect)(toNode3)(createTextNode2("")(document2))();
      var observer = mutationObserver(function(v) {
        return function(v1) {
          return function __do4() {
            modify_(either(function() {
              var $9 = add(semiringInt)(1);
              return function($10) {
                return Right.create($9($10));
              };
            }())(Right.create))(nextTick)();
            return run3();
          };
        };
      })();
      ...
      return bind(bindEffect)(read(nextTick))(traverse_(applicativeEffect)(foldableEither)(function(tick) {
        return function __do4() {
          write(new Left(tick + 1 | 0))(nextTick)();
          return setNodeValue(show(showInt)(tick))(obsvNode)();
        };
      }));
    };
  };
  var makeInterface = function __do2() {
    var freshRef = $$new(0)();
    var listenersRef = $$new(empty2)();
    var notify2 = function(ev) {
      return bindFlipped(bindEffect)(traverse_(applicativeEffect)(foldableMap)(function(v) {
        return v(ev);
      }))(read(listenersRef));
    };
    var locationState = function __do3() {
      var loc = bind(bindEffect)(windowImpl)(location)();
      var state3 = bind(bindEffect)(bind(bindEffect)(windowImpl)(history))(state2)();
      var pathname2 = pathname(loc)();
      var search2 = search(loc)();
      var hash2 = hash(loc)();
      var path = pathname2 + (search2 + hash2);
      return {
        state: state3,
        pathname: pathname2,
        search: search2,
    ...
    var listen2 = function(k) {
      return function __do3() {
        var fresh2 = read(freshRef)();
        write(fresh2 + 1 | 0)(freshRef)();
        modify_(insert(ordInt)(fresh2)(k))(listenersRef)();
        return modify_($$delete(ordInt)(fresh2))(listenersRef);
      };
    };
    var schedule = makeImmediate(bindFlipped(bindEffect)(notify2)(locationState))();
    var stateFn = function(op) {
      return function(state3) {
        return function(path) {
          return function __do3() {
            bind(bindEffect)(bind(bindEffect)(windowImpl)(history))(op(state3)("")(path))();
            return schedule();
          };
        };
      };
    ...
    var listener = eventListener(function(v) {
      return bindFlipped(bindEffect)(notify2)(locationState);
    })();
    bind(bindEffect)(windowImpl)(function() {
      var $11 = addEventListener(popstate)(listener)(false);
      return function($12) {
        return $11(toEventTarget($12));
      };
    }())();
    return {
      pushState: stateFn(pushState),
      replaceState: stateFn(replaceState),
      locationState,
      listen: listen2
    };
  };
  ...
  var LocationChanged = /* @__PURE__ */ function() {
    function LocationChanged2(value0, value1) {
      this.value0 = value0;
      this.value1 = value1;
    }
    ;
    LocationChanged2.create = function(value0) {
      return function(value1) {
        return new LocationChanged2(value0, value1);
      };
    };
    return LocationChanged2;
  }();
  var slotId6 = /* @__PURE__ */ function() {
    return $$Proxy.value;
  }();
  var component6 = function(dictMonadEffect) {
    var render = function(st) {
      if (st.currentRoute instanceof Auth) {
        if (st.currentRoute.value0 instanceof Signin) {
          return slot_()({
            reflectSymbol: function() {
              return "signinForm";
            }
          })(ordUnit)(slotId4)(unit)(component4(dictMonadEffect))(unit);
        }
        ;
        if (st.currentRoute.value0 instanceof Signup) {
          return slot_()({
            reflectSymbol: function() {
              return "signupForm";
            }
          })(ordUnit)(slotId5)(unit)(component5(dictMonadEffect))(unit);
        }
        ;
        throw new Error("Failed pattern match at Router (line 51, column 25 - line 53, column 68): " + [st.currentRoute.value0.constructor.name]);
      }
      ;
      if (st.currentRoute instanceof Week) {
        return div_([text5("Week")]);
      }
      ;
      if (st.currentRoute instanceof NotFound) {
        return div_([text5("404")]);
      }
      ;
      throw new Error("Failed pattern match at Router (line 50, column 17 - line 55, column 44): " + [st.currentRoute.constructor.name]);
    };
    var locationChangeNotify = function(listener) {
      return function(v) {
        return function __do3() {
          v.listen(function(newLocationState) {
            return function __do4() {
              var hash2 = getHash();
              return notify(listener)(new LocationChanged(newLocationState, hash2))();
            };
          })();
          return unit;
        };
    ...
    var hashToRoute = function(hash2) {
      return either($$const(NotFound.value))(identity(categoryFn))(runMatch(routing)(singleton3(new Path(hash2))));
    };
    var handleAction = function(v) {
      if (v instanceof Initialize2) {
        return bind(bindHalogenM)(liftEffect(monadEffectHalogenM(dictMonadEffect))(function __do3() {
          var pushStateInterface = makeInterface();
          setHash2(routes(new Auth(Signin.value)))();
          var v1 = create3();
          locationChangeNotify(v1.listener)(pushStateInterface)();
          return {
            pushStateInterface,
            emitter: v1.emitter
          };
        }))(function(v1) {
          return bind(bindHalogenM)(subscribe2(v1.emitter))(function() {
            return modify_2(monadStateHalogenM)(function(v2) {
              ...
              ;
              $20.pushStateInterface = new Just(v1.pushStateInterface);
              return $20;
            });
          });
        });
      ...
      ;
      if (v instanceof LocationChanged) {
        var newRoute = hashToRoute(v.value1);
        return bind(bindHalogenM)(modify_2(monadStateHalogenM)(function(v1) {
          var $25 = {};
          for (var $26 in v1) {
          ...
          ;
          $25.currentRoute = newRoute;
          $25.currentHash = v.value1;
          $25.locationState = new Just(v.value0);
          return $25;
        }))(function() {
          return pure(applicativeHalogenM)(unit);
        });
      ...
      ;
      throw new Error("Failed pattern match at Router (line 57, column 5 - line 68, column 67): " + [v.constructor.name]);
    };
    return mkComponent({
      initialState: function(v) {
        return {
          currentRoute: new Auth(Signin.value),
          locationState: Nothing.value,
          pushStateInterface: Nothing.value,
          currentHash: ""
        };
      },
      render,
  ...
  var rootComponent = function(dictMonadEffect) {
    var render = function(v) {
      return slot_()({
        reflectSymbol: function() {
          return "router";
        }
      })(ordUnit)(slotId6)(unit)(component6(dictMonadEffect))(unit);
    };
    return mkComponent({
  ...
  var main2 = /* @__PURE__ */ runHalogenAff(/* @__PURE__ */ bind(bindAff)(/* @__PURE__ */ selectElement("#root"))(function(container) {
    if (container instanceof Just) {
      return runUI2(rootComponent(monadEffectAff))(unit)(container.value0);
    }
    ;
    if (container instanceof Nothing) {
      return throwError(monadThrowAff)(error("No container has been found"));
    }
    ;
    throw new Error("Failed pattern match at Main (line 38, column 5 - line 40, column 66): " + [container.constructor.name]);
  }));
